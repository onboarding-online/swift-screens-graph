//
// ScreenImageTitleSubtitleList.swift
//
...
public struct ScreenImageTitleSubtitleList: Codable, JSONEncodable, Hashable {
    ...
    public init(navigationBar: NavigationBar, footer: Footer, styles: BasicScreenBlock, permission: RequestPermission?, timer: ScreenTimer?, animationEnabled: Bool, useLocalAssetsIfAvailable: Bool, imageTitleSubtitleListDescription: String, image: Image, title: Text, subtitle: Text, list: RegularList) {
