...
public struct PickerBlock: Codable, JSONEncodable, Hashable {
    ...
    public init(verticalAlignment: VerticalAlignment? = nil, backgroundColor: String? = nil, paddingLeft: Double? = nil, paddingRight: Double? = nil, paddingTop: Double? = nil, paddingBottom: Double? = nil, borderRadius: Double? = nil, borderColor: String? = nil, borderWidth: Double? = nil) {
