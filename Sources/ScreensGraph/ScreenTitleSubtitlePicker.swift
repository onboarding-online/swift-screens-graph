//
// ScreenTitleSubtitlePicker.swift
//
...
public struct ScreenTitleSubtitlePicker: Codable, JSONEncodable, Hashable {
    ...
    public init(navigationBar: NavigationBar, footer: Footer, styles: BasicScreenBlock, permission: RequestPermission?, timer: ScreenTimer?, animationEnabled: Bool, useLocalAssetsIfAvailable: Bool, titleSubtitlePickerDescription: String, title: Text, subtitle: Text, picker: Picker) {
