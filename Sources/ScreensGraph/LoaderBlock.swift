...
public struct LoaderBlock: Codable, JSONEncodable, Hashable {
    ...
    public init(color: String? = nil, paddingLeft: Double? = nil, paddingRight: Double? = nil, paddingTop: Double? = nil, paddingBottom: Double? = nil) {
        self.color = color
