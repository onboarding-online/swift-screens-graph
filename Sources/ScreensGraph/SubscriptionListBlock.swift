...
public struct SubscriptionListBlock: Codable, JSONEncodable, Hashable {
    ...
    public init(verticalAlignment: VerticalAlignment? = nil, useMaxCellHeight: Bool? = nil, backgroundColor: String? = nil, paddingLeft: Double? = nil, paddingRight: Double? = nil, paddingTop: Double? = nil, paddingBottom: Double? = nil, borderRadius: Double? = nil, borderColor: String? = nil, borderWidth: Double? = nil, itemsSpacing: Double? = nil) {
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try container.encodeIfPresent(itemsSpacing, forKey: .itemsSpacing)
    }
}
