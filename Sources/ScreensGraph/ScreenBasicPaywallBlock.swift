...
public struct ScreenBasicPaywallBlock: Codable, JSONEncodable, Hashable {
    ...
    public init(background: BackgroundStyle, paddingLeft: Double? = nil, paddingRight: Double? = nil, paddingTop: Double? = nil, paddingBottom: Double? = nil, bodyColor: String? = nil, bodyOpacity: String? = nil, bodyShadowMask: RgbaShadowMask? = nil) {
