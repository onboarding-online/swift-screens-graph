//
// ScreenImageTitleSubtitlePicker.swift
//
...
public struct ScreenImageTitleSubtitlePicker: Codable, JSONEncodable, Hashable {
    ...
    public init(navigationBar: NavigationBar, footer: Footer, styles: BasicScreenBlock, permission: RequestPermission?, timer: ScreenTimer?, animationEnabled: Bool, useLocalAssetsIfAvailable: Bool, imageTitleSubtitlePickerDescription: String, image: Image, title: Text, subtitle: Text, picker: Picker) {
